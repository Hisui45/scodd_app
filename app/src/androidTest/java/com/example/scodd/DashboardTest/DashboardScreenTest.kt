package com.example.scodd.DashboardTest
...
import com.example.scodd.ui.dashboard.DashboardViewModel
...
class ScoddChoreTest{
    ...
    fun displayTask_whenRepositoryHasData() = runTest {
        ...
        choreRepository.createChoreItem("0", ROUNDUP)
    ...
    private fun setContent() {
        composeTestRule.setContent {
            ScoddTheme {
                Surface{
                    DashboardScreen(
                        viewModel = DashboardViewModel(choreRepository = choreRepository,
