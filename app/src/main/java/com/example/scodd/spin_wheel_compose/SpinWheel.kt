...
import androidx.compose.ui.unit.dp
import com.example.scodd.spin_wheel_compose.state.SpinWheelState
import com.example.scodd.spin_wheel_compose.state.rememberSpinWheelState
...
object SpinWheelDefaults{
    ...
    fun spinWheelColors(
        ...
        selectorColor: Color = Color.Black,
