...
import com.example.scodd.components.AddChoreButton
import com.example.scodd.components.ChoreListItem
import com.example.scodd.components.NavigationButton
import com.example.scodd.components.StatusBar
import com.example.scodd.objects.ScoddWorkflow
import com.example.scodd.objects.Workflow3
...
@Composable
fun WorkflowScreen(workflowTitle : String?, onNavigateBack : () -> Unit, onAddChoreClick : (ScoddWorkflow) -> Unit){ //Use unique ids
