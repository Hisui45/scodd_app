...
@Composable
fun SelectChoreScreen(onSelectFinish : (List<Chore>) -> Unit,
                      onNavigateBack: () -> Unit,
...
//                ChoreView(scoddRooms, onChipSelected = {}, chores = scoddChores, onChoreSelected = {}, nestedScrollConnection = nestedScrollConnection, onFavoriteSelected = {}  )
