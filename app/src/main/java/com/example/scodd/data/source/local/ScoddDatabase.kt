...
@Database(entities = [LocalChore::class,LocalRoom::class,LocalWorkflow::class,LocalChoreItem::class, LocalMode::class, LocalUser::class], version = 1, exportSchema = false)
